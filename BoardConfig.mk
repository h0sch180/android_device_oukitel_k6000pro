...
#BOARD_MKBOOTIMG_ARGS := --kernel_offset $(BOARD_KERNEL_OFFSET) --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --tags_offset $(BOARD_TAGS_OFFSET) --board K6000Pro_V0
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --tags_offset $(BOARD_TAGS_OFFSET) --board OUKITEL_K6000Pro
...
# Assert
TARGET_OTA_ASSERT_DEVICE := k6000pro,K6000Pro,OUKITEL_K6000Pro,oukitel_k6000pro
